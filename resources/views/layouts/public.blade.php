    ...
    <nav class="navbar navbar-expand-lg fixed-top site-navbar navbar-light js-navbar-scroll">
        <div class="container">
            <a class="navbar-brand d-flex align-items-center" href="{{ route('home') }}">
                <x-parish-logo class="me-3 brand-mark" alt="Logo São Paulo Apóstolo" />
                <div>
                ...
                <div class="d-flex gap-2 ms-lg-3 mt-3 mt-lg-0">
                    ...
                    @auth
                        <a href="{{ \App\Helpers\DashboardHelper::getDashboardRoute(auth()->user()->role) }}" class="btn btn-outline-primary">
                            <i class="bi bi-gear me-1"></i>Painel administrativo
                        </a>
                    @else
            ...
            <div class="row g-4">
                <div class="col-lg-4">
                    <div class="d-flex align-items-center gap-3 mb-3">
                        <x-parish-logo class="logo-footer" alt="Logo São Paulo Apóstolo" />
                        <div>
