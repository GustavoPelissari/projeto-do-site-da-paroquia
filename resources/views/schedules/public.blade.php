...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    ...
    <div class="text-center mb-12">
        <h1 class="text-4xl font-bold text-gray-900 mb-4">Escalas - {{ $group->name }}</h1>
    ...
    @if($currentSchedule)
        ...
        <div class="bg-gradient-to-r from-blue-500 to-blue-600 rounded-lg p-8 text-white mb-8">
            <div class="flex items-center justify-between">
                <div>
                    <h2 class="text-2xl font-bold mb-2">📅 Escala Atual</h2>
                    <h3 class="text-xl font-semibold mb-3">{{ $currentSchedule->title }}</h3>
    ...
    @if($schedules->count() > 0)
        <div class="bg-white rounded-lg shadow-md overflow-hidden mb-8">
            <div class="px-6 py-4 border-b border-gray-200">
                <h2 class="text-xl font-semibold text-gray-900">Histórico de Escalas</h2>
            </div>
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <div class="flex items-center space-x-3">
                                ...
                                <a href="{{ $schedule->getPdfUrl() }}" target="_blank"
                                   class="bg-blue-600 text-white px-3 py-1 rounded text-sm hover:bg-blue-700 inline-flex items-center">
    ...
    <div class="bg-white rounded-lg shadow-md p-6">
        <h2 class="text-xl font-semibold text-gray-900 mb-4">Sobre o Grupo</h2>
