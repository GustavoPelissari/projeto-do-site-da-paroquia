                        ...
                        <div class="mb-6">
                            ...
                            <div class="border-2 border-dashed border-gray-300 rounded-lg p-6">
                                <div class="text-center">
                                    ...
                                    <div class="d-flex justify-center text-sm text-gray-600">
                                        <label for="pdf_file" class="position-relative cursor-pointer bg-white rounded-md font-medium text-indigo-600 hover-text-indigo-500">
