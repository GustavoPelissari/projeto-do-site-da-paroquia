                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                <div class="d-flex gap-2 justify-content-end">
                                    <a href="{{ route('admin.global.news.show', $item) }}" class="btn btn-outline-secondary btn-sm" title="Ver"><i class="bi bi-eye me-1"></i>Ver</a>
                                    <a href="{{ route('admin.global.news.edit', $item) }}" class="btn btn-secondary btn-sm" title="Editar"><i class="bi bi-pencil me-1"></i>Editar</a>
