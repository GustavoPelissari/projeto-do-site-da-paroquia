            ...
            <div class="col-12 col-lg-4 d-flex flex-column gap-4">
                    ...
                    <div class="d-flex flex-column gap-3">
                        ...
                        <div>
                            <label class="form-check">
                                ...
                                <span class="form-check-label">Destacar na página inicial</span>
                            </label>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="datetime-local" name="published_at" id="published_at" 
                                   ...
                                   class="form-control">
                            <p class="form-text">Deixe vazio para usar data atual</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-secondary-subtle rounded p-3">
                    ...
                    @if($news->featured_image)
                        <div class="mb-3">
                            <p class="form-label fw-medium">Imagem atual:</p>
                    ...
                    <div id="image-preview" class="mt-3 d-none">
                        <p class="form-label fw-medium">Nova imagem:</p>
