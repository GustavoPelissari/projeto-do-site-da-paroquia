                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex gap-2 justify-content-center">
                                            <button type="button" class="btn btn-sm btn-outline-success" data-pdf-url="{{ asset('storage/' . $scale->file_path) }}" data-pdf-title="{{ $scale->title }}" onclick="viewPDF(this.getAttribute('data-pdf-url'), this.getAttribute('data-pdf-title'))" title="Visualizar PDF">
                                                <i class="bi bi-eye me-1" aria-hidden="true"></i>Ver
                                            </button>
                                            <a href="{{ route('admin.coordenador.scales.download', $scale) }}" class="btn btn-sm btn-outline-primary" title="Baixar PDF">
                                                <i class="bi bi-download me-1" aria-hidden="true"></i>Baixar
                                            </a>
                                            <form action="{{ route('admin.coordenador.scales.destroy', $scale) }}" method="POST" class="d-inline" onsubmit="return confirm('Tem certeza que deseja remover esta escala?')">
                                                @csrf @method('DELETE')
